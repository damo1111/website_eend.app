...
export default function AppCard({ app }: { app: App }) {
  const { name, studio, tag, problem, solution, screengrab, accent } = app;
  ...
  return (
    <div
      className={cn(
        "group relative flex h-full min-h-[340px] flex-col justify-end overflow-hidden rounded border border-border bg-surface p-7",
